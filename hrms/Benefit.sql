CREATE TABLE [dbo].[Benefit] (
    ...
    [days]         INT            NOT NULL,
    CONSTRAINT [PK_Benefit] PRIMARY KEY CLUSTERED ([benefit_id] ASC),
    CONSTRAINT [FK_Benefit_EmployeeDetails_user_id] FOREIGN KEY ([user_id]) REFERENCES [dbo].[EmployeeDetails] ([employee_id]) ON DELETE CASCADE
);
