...
import 'package:hrm_hrmtest/screens/forgotPassword.dart';
import 'package:hrm_hrmtest/screens/signUp.dart';
import 'home.dart';
...
class _Login extends State<Login>{
  List<String> items = ['Select a company','Item 1','Item 2','Item 3','Item 4'];
          ...
          children:<Widget>[
            Column(children: [
              Align(alignment: Alignment(-0.8,1.2),
                  child:  Text('Company Name', style: TextStyle(height:5,fontSize:20,))),
              SizedBox(
              width:350,
            ...
            Align(alignment: Alignment(-0.8,1.2),
              child: Text('Emplyee ID' ,style: TextStyle(height:2,fontSize:20,)),),
              Container(
            ...
            Align(alignment: Alignment(-0.8,1.2),
            child:  Text('Password' ,style: TextStyle(height:2,fontSize:20))),
            Container(
              padding: EdgeInsets.symmetric(horizontal: 30,vertical: 5),
              child:TextField(
                decoration:InputDecoration(
