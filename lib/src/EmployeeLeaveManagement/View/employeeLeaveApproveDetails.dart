...
class EmployeeLeaveApproveDetails extends StatefulWidget {
  const EmployeeLeaveApproveDetails({super.key, required this.myLeave});

  final Leaves myLeave;


  @override
  State<EmployeeLeaveApproveDetails> createState() => _EmployeeLeaveApproveDetails();
}

class _EmployeeLeaveApproveDetails extends State<EmployeeLeaveApproveDetails> {
