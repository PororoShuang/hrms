...
import 'employeeLeaveRejectDetails.dart';
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: ListTile(
                                title: Text(
                                    leaveDescendedRejectList[index].staff_id ??
                                        "-"),
                                subtitle: Text(leaveDescendedRejectList[index]
                                        .staff_name ??
                                    "-"),
                              ),
                            ),
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            EmployeeLeaveRejectDetails(
                                                myLeave:
                                                    leaveDescendedRejectList[
                                                        index])),
                                  );
                                },
                                child: Padding(
