...
class _SignUp extends State<SignUp>{
  ...
  List<String> itemsSupervisor = ['Select a Supervisor Name','Item 1','Item 2','Item 3','Item 4'];
        ...
        child: Column (
          children: <Widget>[
            ...
            Align(alignment: Alignment(-0.8,1.2),
              child: Text('Gender' ,style: TextStyle(height:2,fontSize:20,color: Colors.black45)),),
            Row(
              children:[
                Expanded(
                  flex:1,
            ...
            Container(
              child: SizedBox(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  value:item,
                  child:Text(item,style:TextStyle(fontSize:19,fontStyle: FontStyle.italic,color: Colors.black45)),
                ))
                    .toList(),
            ...
            Container(
              child: SizedBox(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  value:selectedItemSupervisor,items:itemsSupervisor
                    .map((item)=> DropdownMenuItem<String>(
                  value:item,
                  child:Text(item,style:TextStyle(fontSize:19,fontStyle: FontStyle.italic,color: Colors.black45)),
                ))
                    .toList(),
                  onChanged:(item)=>setState(()=> selectedItemSupervisor=item),
                ),
              ),
            ),
            SizedBox(height: 10,),
